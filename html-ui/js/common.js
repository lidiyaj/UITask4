...
*/
var products_url = "http://localhost:30093/products/products/";

var inventory_url = "http://localhost:30093/inventory/inventory/";

var customer_login_url = 'http://localhost:30093/customers/login/'
      ...
      console.log(sessionStorage.products);
		...
		var cartProducts=[];
		 ...
		 products.forEach(function(product) {
				...
				cartProduct.total = (product.price * product.qty);
		...
		.then(response => {
			...
			console.log(`Successfully created order`, added);
			alert("check out");
			setTimeout(function(){
			 window.location.href = 'shop.html';
			 }, 1000);
